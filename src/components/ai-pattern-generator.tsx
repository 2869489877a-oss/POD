  ...
  return (
    <div className="space-y-4">
      ...
      <form onSubmit={handleGenerate} className="space-y-3">
        ...
        <div>
          <label className={`block text-xs font-medium mb-1.5 ${isDark ? "text-slate-400" : "text-slate-600"}`}>参考图 URL (可选，用于风格参考)</label>
        ...
        {applyMode && (
          <div>
            <label className={`block text-xs font-medium mb-1.5 ${isDark ? "text-slate-400" : "text-slate-600"}`}>衣服模板图片 URL</label>
