      ...
      <div className="space-y-8">
        ...
        <div className="border-t border-violet-500/10 pt-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="rounded-xl border border-violet-500/10 bg-[#12122a] p-4">
              <p className="text-xs font-medium text-slate-500">版本</p>
              <p className="mt-1 text-sm font-semibold text-white">v0.1.0</p>
            </div>
            <div className="rounded-xl border border-violet-500/10 bg-[#12122a] p-4">
              <p className="text-xs font-medium text-slate-500">运行环境</p>
              <p className="mt-1 text-sm font-semibold text-white">Next.js + Supabase</p>
            </div>
            <div className="rounded-xl border border-violet-500/10 bg-[#12122a] p-4">
              <p className="text-xs font-medium text-slate-500">支持的 AI 平台</p>
              <p className="mt-1 text-sm text-slate-300">Gemini · OpenAI · 豆包 · 通义万相</p>
            </div>
            <div className="rounded-xl border border-violet-500/10 bg-[#12122a] p-4">
              <p className="text-xs font-medium text-slate-500">图片处理</p>
              <p className="mt-1 text-sm text-slate-300">Sharp · 抠图 · 印花提取 · 套图</p>
            </div>
          </div>
        </div>
      </div>
