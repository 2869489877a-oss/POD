...
export const navItems: NavItem[] = [
  ...
  { titleZh: "图片裂变", titleEn: "Image Fission", href: "/image-fission", descZh: "AI语义裂变与本地快速裂变，支持一图多变体", descEn: "AI semantic fission and local quick fission with one-to-many variants", icon: "M12 2.25 13.91 8.09 19.75 6.18 15.91 11.5 19.75 16.82 13.91 14.91 12 20.75 10.09 14.91 4.25 16.82 8.09 11.5 4.25 6.18 10.09 8.09 12 2.25Z" },
