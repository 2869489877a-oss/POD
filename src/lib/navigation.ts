...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    hrefs: ["/image-jobs", "/image-fission", "/print-extraction", "/cutout", "/ai-image"],
  },
  {
    labelZh: "商品输出",
...
export const navItems: NavItem[] = [
  ...
  { titleZh: "图片裂变", titleEn: "Image Fission", href: "/image-fission", descZh: "批量生成镜像、万花镜、残影、错位和平铺变体", descEn: "Batch-generate mirror, kaleidoscope, echo, slice and tile variants", icon: "M12 2.25 13.91 8.09 19.75 6.18 15.91 11.5 19.75 16.82 13.91 14.91 12 20.75 10.09 14.91 4.25 16.82 8.09 11.5 4.25 6.18 10.09 8.09 12 2.25Z" },
